...
- [Preparing your django application for deployment](#preparing-your-django-application-for-deployment)
- [Choosing a hosting platform](#choosing-a-hosting-platform)
- [Deploying your django app on pythonanywhere](#deploying-your-django-app-on-pythonanywhere)
    - [Upload your code on pythonanywhere](#upload-your-code-on-pythonanywhere)
    - [Setting up your web-app](#setting-up-your-web-app-and-wsgi-file)
    - [Creating a web-app with manual config](#create-a-web-app-with-manual-config)
    - [Editing your wsgi file](#edit-your-wsgi-file)
- [Deploying your django app on heroku](#deploying-your-django-app-on-heroku)
- [Some words on maintenance and monitoring](#tips-for-maintenance-and-monitoring)
