---
publishedAt: 2021-05-20T16:14:48.341Z
...
Python, Flow control and functions in python](/blog/operators-control-flow-and-functions-in-python-python-basics-masterclass-continued) in the next post. Until
