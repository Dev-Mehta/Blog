...
As I went on to search the best resources to study data structure and algorithms, I found a wonderful [study plan](https://github.com/jwasham/coding-interview-university) by [John Washam](https://github.com/jwasham/) which was prepared for cracking Google Software Engineer Coding Interview. You can take a look at it [here](https://github.com/jwasham/coding-interview-university). Instead of forking his same repo, I wanted my coding structure to be a bit different. Long story short, I created [my own repo](https://github.com/Dev-Mehta/100DaysOfCode) for archiving my code of these learnings over there.
...
Other solutions are available on [my github repo](https://github.com/Dev-Mehta/100DaysOfCode/tree/master/Day%201%20-%20Arrays).
...
I would be also posting solutions of [Day #2 - Linked Lists](https://github.com/Dev-Mehta/100DaysOfCode/) if tends out to be helpful for you. Until then, happy coding.

**Edit**

I have shared all the C++ code of the things I have learnt till now in the [repo](https://github.com/Dev-Mehta/100DaysOfCode/). You can check it on github and star, fork or contribute just play around with it if you like it. It contains all the code of major data structures like Arrays, Linked Lists, Queues, Hash Maps, Trees etc.
