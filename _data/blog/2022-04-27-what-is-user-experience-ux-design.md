---
template: BlogPost
path: /what-is-user-experience-ux-design
date: 2022-04-27T12:52:34.096Z
title: What is User Experience(UX) Design?
metaDescription: >-
  The user experience is how a person, the user, feels about interacting with or
  experiencing a product. A product is a good, service, or feature. It might be
  a physical product, like a video game controller or a bag of potato chips, or
  a technology product, like an app, website, or smartwatch.
---
...
- [What is User Experience(UX) Design](#what-is-user-experienceux-design)
- [What makes a good ux design](#what-makes-a-good-ux-design)
  - [What is Usability of Product](#usablility)
  - [What is Equitability of Product](#equitability)
  - [What is Enjoyability of Product](#enjoyability)
  - [What is Usefulness of Product](#usefulness)
...
Let's break that down. To begin, user experience is about improving usability or making something easier to use. This means that the design, structure, and purpose of the product are
clear to everyone. 
...
To know how users feel, we have to collect evidence on how they're experiencing that product in real time
and ask them about it, too. 

> **Summing it up, and putting it in [Naval's](https://nav.al/build-sell) way, if you learn to build, (a useful product) and learn to sell (make the whole experience), you will be unstoppable**
