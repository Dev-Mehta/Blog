...
date: 2021-07-17T14:20:47.887Z
title: How to Create Your Own Git with Python
metaDescription: >-
  Git is known for its very simple object model – and for good reason. For this
  article, I wanted to write a version that could do all the steps including
  pushing to a real Git server. I also wanted to use the same binary index
  format that git used so I could check my work using git commands at each step
  of the way.
---
